  ...
  return (
    <footer className="bg-card border-t border-border pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
        <div className="col-span-1 md:col-span-1">
          ...
          <p className="text-muted-foreground text-sm">
            Precision-engineered industrial packing solutions. Empowering manufacturers across India since 2010.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <li>contact@techpacksolutions.in</li>
      ...
      <div className="max-w-7xl mx-auto px-6 pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between text-xs text-muted-foreground">
        <p>&copy; {currentYear} Techpack Solutions. All rights reserved.</p>
